package kr.jaehyeon.customadapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View view, ViewGroup viewGroup) {
            ...
            // 뷰를 구성한다.
            TextView sub_text = view.findViewById(R.id.textView);
            Button sub_btn1 = view.findViewById(R.id.button);
            Button sub_btn2 = view.findViewById(R.id.button2);
