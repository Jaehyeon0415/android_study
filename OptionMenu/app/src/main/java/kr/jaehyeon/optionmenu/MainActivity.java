package kr.jaehyeon.optionmenu;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override
    // Activity가 화면에 나타날 때 메뉴 구성을 위해서 호출하는 메서드
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
            case R.id.item1:
                ...
                break;
            case R.id.item2_1:
                text1.setText("서브메뉴2_1을 눌렀습니다.");
                break;
            case R.id.item2_2:
                text1.setText("서브메뉴2_2을 눌렀습니다.");
                break;
            case R.id.item3:
        ...
        switch (id) {
            case Menu.FIRST:
                ...
                break;
            case Menu.FIRST + 10:
                text1.setText("코드 서브 메뉴1을 눌렀습니다.");
                break;
            case Menu.FIRST + 20:
                text1.setText("코드 서브 메뉴2를 눌렀습니다.");
                break;
            case Menu.FIRST + 2:
