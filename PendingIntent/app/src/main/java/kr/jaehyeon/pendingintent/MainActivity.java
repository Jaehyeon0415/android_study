package kr.jaehyeon.pendingintent;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btn1Method(View view) {
        ...
        intent1.putExtra("data1", "문자열 데이터")
                .putExtra("data2", 100);

        // 추가 액션을 설정한다.
        Intent intent1_2 = new Intent(this, Test2Activity.class);
        PendingIntent pending2 = PendingIntent.getActivity(this, 100, intent1_2, PendingIntent.FLAG_UPDATE_CURRENT);
        ...
        // Intent 객체를 관리할 PendingIntent 객체를 생성하여 관리한다.
