package kr.jaehyeon.stylenotification;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void btn3Method(View view) {
        ...
        // 표시할 문자열을 셋팅한다.
        inbox.addLine("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
        inbox.addLine("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb");
        inbox.addLine("ccccccccccccccccccccccccccccccccccccccccccccccccccccccc");
        inbox.addLine("ddddddddddddddddddddddddddddddddddddddddddddddddddddddd");
        inbox.addLine("eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee");
        inbox.addLine("fffffffffffffffffffffffffffffffffffffffffffffffffffffff");
